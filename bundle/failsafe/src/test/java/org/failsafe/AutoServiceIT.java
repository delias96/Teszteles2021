...
import hu.uni.miskolc.teszteles.dao.mongo.AutoDAOMongo;
...
public class AutoServiceIT {
	...
	public static void setUp() {
		dao = new AutoDAOMongo("mongodb+srv://test:test@szoftverteszteles2021.bqwgi."
				+ "mongodb.net/test?retryWrites=true&w=majority", "autok", "autok");
	...
	public void test() throws RendszamNemMegfelelo, GyartasiIdoNemMegfelelo, AjtokSzamaNemMegfelelo, RendszamMarFoglalt {
		Auto auto = new Auto("Opel","Astra","1.2" , "ABC-123", Uzemanyag.BENZIN, LocalDate.of(2017, 5,12),
				"#dedede",	false, "123456EE", Valto.MANUALIS_5_FOKOZAT, Kivitel.KOMBI, 5);
